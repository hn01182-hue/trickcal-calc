...
const constantPackages = [
    ...
    { name: "트릭컬 패스 (기본)", price: 11000, category: "월간 패키지", contents: { gold: 66, p_elif: 700, t_card: 6, t_apostle: 6, kcandy: 300, scandy: 200, marsh_high_select: 10, marsh_mid_select: 40, marsh_low_select: 60, r_high: 3, r_mid: 6, r_low: 9, crayon_high: 3, crayon_highest: 2 } },
