...
const defaultConfig = {
	...
	manualCriteria: [],
        items: [
            ...
            { id: 'food_blue', name: '새콤비타F', val: 0, icon: 'images/파란랜덤밥.png', count: "" },
            { id: 'food_purple', name: '얌얌비타C', val: 0, icon: 'images/보라랜덤밥.png', count: "" },
			{ id: 'food_yellow', name: '킹짱비타K', val: 0, icon: 'images/노란밥.webp', count: "" },
