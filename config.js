...
const defaultConfig = {
        ...
        items: [
			...
			{ id: 'marsh_low_select', name: '하급 마시멜로 선택 상자', val: 0.3, icon: 'images/하급 마시멜로 선택 상자.webp', count: "" },
			...
			{ id: 'marsh_mid_select', name: '중급 마시멜로 선택 상자', val: 0.9, icon: 'images/중급 마시멜로 선택 상자.webp', count: "" },
			...
			{ id: 'marsh_high_select', name: '상급 마시멜로 선택 상자', val: 4.5, icon: 'images/상급 마시멜로 선택 상자.webp', count: "" },
